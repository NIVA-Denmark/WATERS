...
CalculateIndicator_Chla(df,c(6,7,8),
                        ...
                        parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stat*year(vand*peri)"],
                        parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "proevetager"],
...
CalculateIndicator_ChlaEQR(df,RefCond_sali,c(6,7,8),
                        parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "year(vandomr*period)"],
                        parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stati(vandom*period)"],
                        parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stat*year(vand*peri)"],
                        parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "proevetager"],
...
CalculateIndicator_nutrientEQR("TNsummer",df,RefCond_sali,c(6,7,8),
                          parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "year(vandomr*period)"],
                          parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stati(vandom*period)"],
                          parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stat*year(vand*peri)"],
                          parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "proevetager"],
...
CalculateIndicator_nutrientEQR("TNwinter",df,RefCond_sali,c(11,12,1,2),
                               parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "year(vandomr*period)"],
                               parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stati(vandom*period)"],
                               parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "stat*year(vand*peri)"],
                               parmlist$covparams_CumCover$Estimate[parmlist$covparams_CumCover$CovParm == "proevetager"],
